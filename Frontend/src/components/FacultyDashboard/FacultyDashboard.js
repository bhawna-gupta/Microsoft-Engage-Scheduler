  ...
  const NoCard = () => (
    <>
      <div className={classes.nocard_div}>
        <Link style={{ textDecoration: "none" }} to="/allotment">
          <Button
            style={{ display: "block", backgroundColor: "#8899a6" }}
            variant="contained"
            size="large"
          >
            Check List of Students of Class 7
          </Button>
          <br></br>
        </Link>
        <Link style={{ textDecoration: "none" }} to="/allotment">
          <Button
            ...
            size="large"
          >
            Check List of Students of Class 8
          </Button>
          <br></br>
        </Link>
        <Link style={{ textDecoration: "none" }} to="/allotment">
          <Button
            ...
            size="large"
          >
            Check List of Students of Class 9
          </Button>
          <br></br>
        </Link>
        <Link style={{ textDecoration: "none" }} to="/allotment">
          <Button
            ...
            size="large"
          >
            Check List of Students of Class 10
          </Button>
        </Link>
      </div>
    </>
            ...
            <Toolbar>
              ...
              >
                <Container className={classes.backdrop_container}>
                  <h2 className={classes.backdrop_text}>
